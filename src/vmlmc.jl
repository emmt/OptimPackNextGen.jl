...
# vmlmc.jl -
#
# Implement Éric Thiébaut's VMLMC algorithm in Julia.
#
#------------------------------------------------------------------------------
#
...
function vmlmc!{T<:AbstractFloat,N}(fg!::Function, x::Array{T,N}, m::Integer,
    ...
    if verb > 0
        ...
        function printer()
            t = time_ns()*1e-9
            if evaluations == 1
                println("# VMLMC algorithm (N=$n, M=$m)")
